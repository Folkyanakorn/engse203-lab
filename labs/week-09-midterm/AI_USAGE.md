...
| เวลา | งาน | Prompt ที่ถาม | AI ตอบว่าอะไร | ฉันทำอะไรต่อ |
|---|---|---|---|---|
| 15:52 | b1 | ผมลืมวิธี push งาน  | ผมลืมใส่ git add . | อัปโหลดงาน |
| 16:10 | b1 ข้อสาม | ผมทำอะไรผิดทำไมงานถึงรันไม่ขึ้น พร้อมส่งโค้ดที่แก้ให้เช็ค | ai บอกผมนิ้วเบียดไปพิมพ์ วงเล็บซ้ำอีกตัว โค้ดเลยไม่รัน | ผมก็ลบแล้วก็จากนั้นก็ดูผลการทดลอง |
